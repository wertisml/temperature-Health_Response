...
Models <- c("GLM_Model_Mental_RUCA_1_2.rds",
            "GAM_Model_Mental_RUCA_1_2.rds",
            "RF_ranger_Mental_RUCA_1_2.rds",
            "xgbTree_Model_Mental_RUCA_1_2.rds")
...
MAPE_test <- MAPE(Obs = Test$Mental_Health, Pred = Test$Pred)
...
Train$Predicted <- round(Test$Predicted) #This might need to be removed
