...
nRMSE_test <- RMSE(Obs = Test$Mental_Health, Pred = Test$Pred) / mean(Test$Mental_Health)

MAE_test <- MAE(Obs = Test$Mental_Health, Pred = Test$Pred)

nMAE_test <- MAE(Obs = Test$Mental_Health, Pred = Test$Pred) / mean(Test$Mental_Health)
